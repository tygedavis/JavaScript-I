...
console.log("Not the sorted array", carModels);
let carModelsSorted = [];
  carModelsSorted = carModels.sort();
console.log("Sorted Array", carModelsSorted);
...
console.log("This is the car years", carYears);
